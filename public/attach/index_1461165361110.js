...
//module.exports = function (app) {
    ...
    app.post('/deleteFileByIdPermanentely',url.setpageDeletePermanentely,portal.deleteFileByIdPermanentely,render.redirect);
...
//---------------------------------Expense------------------------------------------
    ...
    app.post('/isertExpensemaster',url.setexpenseMaster, portal.insert_Expense,portal.getRole);
...
//-------------------------Admin Routes----------------------------------------------------
    ...
    app.get('/masters',url.setpagemasters,portal.holidayhome,portal.select_ExpenseMaster,portal.getDataAsset,portal.getCustomRole,portal.getIndustry,portal.getBusiness,portal.getDocument,portal.getTechnology,portal.getRestriction,portal.getRole,render.redirect);
...
//------------Users-----------------------------
	...
	portal.getDepartment,portal.getLevel,portal.getModules,render.redirect);
	app.post('/addUser', portal.addUser,render.redirect);
